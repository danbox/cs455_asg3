 ...
 * @date 4/29/14.
 */
public class TFIDFTriReducer extends Reducer<NGramWritableComparable, DoubleWritable, NGramWritableComparable, DoubleWritable>
{
    ...
    protected void setup(Context context) throws IOException
    {
        ...
        while(line != null)
        {
            ...
            if(split.length == 4)
            {
                TFResults.put(split[0] + " " + split[1] + " " + split[2], split[3]);
            }
            line = bufferedReader.readLine();
        }
    }
